package com.slipper4j.framework.desensitize.core;

import com.slipper4j.framework.common.util.json.JsonUtils;
import com.slipper4j.framework.desensitize.core.annotation.Address;
import com.slipper4j.framework.desensitize.core.regex.annotation.EmailDesensitize;
import com.slipper4j.framework.desensitize.core.regex.annotation.RegexDesensitize;
import com.slipper4j.framework.desensitize.core.slider.annotation.*;
import com.slipper4j.framework.desensitize.core.slider.annotation.*;
import lombok.Data;
...
public class DesensitizeTest {
    ...
    public void test() {
        ...
        desensitizeDemo.setNickname("slipper4j");
        ...
        desensitizeDemo.setRegex("你好，我是slipper4j");
        desensitizeDemo.setAddress("北京市海淀区上地十街10号");
        desensitizeDemo.setOrigin("slipper4j");
        ...
        assertEquals("slipper4j", d.getOrigin());
    }
    ...
    public static class DesensitizeDemo {
        ...
        @RegexDesensitize(regex = "slipper4j", replacer = "*")
