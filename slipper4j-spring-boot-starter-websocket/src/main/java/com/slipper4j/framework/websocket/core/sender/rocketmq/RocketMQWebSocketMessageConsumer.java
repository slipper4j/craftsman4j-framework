package com.slipper4j.framework.websocket.core.sender.rocketmq;
...
@RocketMQMessageListener( // 重点：添加 @RocketMQMessageListener 注解，声明消费的 topic
        topic = "${slipper4j.websocket.sender-rocketmq.topic}",
        consumerGroup = "${slipper4j.websocket.sender-rocketmq.consumer-group}",
