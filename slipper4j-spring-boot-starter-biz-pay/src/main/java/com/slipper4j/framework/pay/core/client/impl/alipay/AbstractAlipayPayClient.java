package com.slipper4j.framework.pay.core.client.impl.alipay;
...
import com.slipper4j.framework.common.util.json.JsonUtils;
import com.slipper4j.framework.common.util.object.ObjectUtils;
import com.slipper4j.framework.pay.core.client.dto.order.PayOrderRespDTO;
import com.slipper4j.framework.pay.core.client.dto.order.PayOrderUnifiedReqDTO;
import com.slipper4j.framework.pay.core.client.dto.refund.PayRefundRespDTO;
import com.slipper4j.framework.pay.core.client.dto.refund.PayRefundUnifiedReqDTO;
import com.slipper4j.framework.pay.core.client.dto.transfer.PayTransferRespDTO;
import com.slipper4j.framework.pay.core.client.dto.transfer.PayTransferUnifiedReqDTO;
import com.slipper4j.framework.pay.core.client.impl.AbstractPayClient;
import com.slipper4j.framework.pay.core.enums.order.PayOrderStatusRespEnum;
import com.slipper4j.framework.pay.core.enums.transfer.PayTransferTypeEnum;
...
import static com.slipper4j.framework.common.exception.enums.GlobalErrorCodeConstants.*;
...
public abstract class AbstractAlipayPayClient extends AbstractPayClient<AlipayPayClientConfig> {
    ...
    protected PayRefundRespDTO doUnifiedRefund(PayRefundUnifiedReqDTO reqDTO) throws AlipayApiException {
        ...
        if (Objects.equals(config.getMode(), AlipayPayClientConfig.MODE_CERTIFICATE)) {  // 证书模式
            response = client.certificateExecute(request);
        } else {
            response = client.execute(request);
        }
