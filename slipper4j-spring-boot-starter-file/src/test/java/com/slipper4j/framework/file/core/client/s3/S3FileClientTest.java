...
public class S3FileClientTest {
    ...
    public void testMinIO() throws Exception {
        ...
        config.setBucket("slipper4jyuanma");
...
//        config.setAccessSecret(System.getenv("QINIU_SECRET_KEY"));
        ...
        config.setBucket("slipper4j");
        config.setDomain("http://test.slipper4j.iocoder.cn"); // 如果有自定义域名，则可以设置。http://static.slipper4j.iocoder.cn
        // 默认上海的 endpoint
