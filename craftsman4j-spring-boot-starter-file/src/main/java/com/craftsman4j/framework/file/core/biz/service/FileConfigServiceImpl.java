package com.craftsman4j.framework.file.core.biz.service;
...
import com.craftsman4j.framework.common.util.validation.ValidationUtils;
import com.craftsman4j.framework.file.core.client.FileClient;
import com.craftsman4j.framework.file.core.client.FileClientConfig;
import com.craftsman4j.framework.file.core.client.FileClientFactory;
import com.craftsman4j.framework.file.core.enums.FileStorageEnum;
...
import com.craftsman4j.framework.file.core.biz.vo.config.FileConfigSaveReqVO;
...
import static com.craftsman4j.framework.common.util.cache.CacheUtils.buildAsyncReloadingCache;
import static com.craftsman4j.framework.file.core.biz.enums.FileErrorCodeConstants.FILE_CONFIG_DELETE_FAIL_MASTER;
import static com.craftsman4j.framework.file.core.biz.enums.FileErrorCodeConstants.FILE_CONFIG_NOT_EXISTS;
...
public class FileConfigServiceImpl implements FileConfigService {
    ...
    public Long createFileConfig(FileConfigSaveReqVO createReqVO) {
        BeanUtils.toBean(createReqVO, FileConfigDO.class);
        CopyOptions copyOptions = CopyOptions.create().setIgnoreProperties(FileConfigDO::getConfig);
        FileConfigDO fileConfig = BeanUtil.toBean(createReqVO, FileConfigDO.class, copyOptions)
    ...
    public void updateFileConfig(FileConfigSaveReqVO updateReqVO) {
        ...
        // 更新
        CopyOptions copyOptions = CopyOptions.create().setIgnoreProperties(FileConfigDO::getConfig);
        FileConfigDO updateObj = BeanUtil.toBean(updateReqVO, FileConfigDO.class, copyOptions)
