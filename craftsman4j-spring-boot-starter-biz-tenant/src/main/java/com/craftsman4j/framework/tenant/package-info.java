 ...
 *      1）Spring Async：
 *          {@link com.craftsman4j.framework.quartz.config.AsyncAutoConfiguration#threadPoolTaskExecutorBeanPostProcessor()}
 *      2）Spring Security：
 *          TransmittableThreadLocalSecurityContextHolderStrategy
 *          和 SecurityAutoConfiguration#securityContextHolderMethodInvokingFactoryBean() 方法
 *
 */
package com.craftsman4j.framework.tenant;
