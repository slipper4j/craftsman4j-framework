package com.craftsman4j.framework.dict.core.service;

import cn.hutool.core.util.StrUtil;
import cn.hutool.extra.spring.SpringUtil;
import com.craftsman4j.framework.common.pojo.PageResult;
import com.craftsman4j.framework.common.util.date.LocalDateTimeUtils;
import com.craftsman4j.framework.common.util.object.BeanUtils;
import com.craftsman4j.framework.dict.core.mapper.DictTypeMapper;
import com.craftsman4j.framework.dict.core.pojo.DictTypeDO;
import com.craftsman4j.framework.dict.core.vo.type.DictTypePageReqVO;
import com.craftsman4j.framework.dict.core.vo.type.DictTypeSaveReqVO;
...
import static com.craftsman4j.framework.dict.core.enums.DictErrorCodeConstants.*;
...
public class DictTypeServiceImpl implements DictTypeService {
    ...
    public void deleteDictType(Long id) {
        ...
        // 校验是否有字典数据
        if (SpringUtil.getBean(DictDataService.class).getDictDataCountByDictType(dictType.getType()) > 0) {
