package com.craftsman4j.framework.websocket.core.util;
...
public class WebSocketFrameworkUtils {
     ...
     */
    public static void setLoginUser(ILoginUser loginUser, Map<String, Object> attributes) {
     ...
     * @return 当前用户
     */
    public static ILoginUser getLoginUser(WebSocketSession session) {
        return (ILoginUser) session.getAttributes().get(ATTRIBUTE_LOGIN_USER);
    }
