package com.craftsman4j.framework.websocket.core.sender.rocketmq;
...
@RocketMQMessageListener( // 重点：添加 @RocketMQMessageListener 注解，声明消费的 topic
        topic = "${craftsman4j.websocket.sender-rocketmq.topic}",
        consumerGroup = "${craftsman4j.websocket.sender-rocketmq.consumer-group}",
