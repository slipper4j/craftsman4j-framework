# taste-spring-boot-starter-signature
`taste-spring-boot-starter-signature` 通过注解的方式实现api接口签名
...
<dependency>
    <groupId>com.taste.code</groupId>
    <artifactId>taste-spring-boot-starter-signature</artifactId>
...
## 步骤1 实现SignatureApi接口提供AppSecret、签名结果
```java
