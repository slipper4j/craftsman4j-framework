...
import com.slipper4j.framework.signature.core.util.SignatureUtils;
import com.slipper4j.framework.web.core.filter.CacheRequestBodyWrapper;
    ...
    protected SortedMap<String, String> getAllParams(Signature signature, HttpServletRequest request) throws IOException {
        ...
        if (StringUtils.isNotBlank(body)) {
            ...
            if (parsedObject instanceof JSONObject) {
                ...
                sortedMap.put("body", JSON.toJSONString(SignatureUtils.traverseMap(jsonObj)));
            } else if (parsedObject instanceof JSONArray) {
                JSONArray jsonArray = (JSONArray) parsedObject;
                sortedMap.put("body", JSON.toJSONString(SignatureUtils.traverseList(jsonArray)));
            } else {
