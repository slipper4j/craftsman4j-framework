package com.slipper4j.framework.operatelog.core.aop;
...
import com.slipper4j.framework.common.util.monitor.TracerUtils;
import com.slipper4j.framework.common.util.servlet.ServletUtils;
import com.slipper4j.framework.operatelog.core.enums.OperateTypeEnum;
import com.slipper4j.framework.operatelog.core.service.OperateLog;
...
import static com.slipper4j.framework.common.exception.enums.GlobalErrorCodeConstants.INTERNAL_SERVER_ERROR;
import static com.slipper4j.framework.common.exception.enums.GlobalErrorCodeConstants.SUCCESS;
...
public class OperateLogAspect {
    ...
    public Object around(ProceedingJoinPoint joinPoint, Operation operation) throws Throwable {
        ...
        com.slipper4j.framework.operatelog.core.annotations.OperateLog operateLog = getMethodAnnotation(joinPoint,
                com.slipper4j.framework.operatelog.core.annotations.OperateLog.class);
    ...
    public Object around(ProceedingJoinPoint joinPoint,
                         com.slipper4j.framework.operatelog.core.annotations.OperateLog operateLog) throws Throwable {
